...
export default function StaffForm() {
          ...
          const updatedRegistros = registros.map(registro => {
            if (!registro.id) {
              const matchingResult = data.results.find(result => 
                ...
                result.fechaIngreso === registro.fechaIngreso && 
                result.cliente === registro.cliente
              )
              return matchingResult ? { ...registro, ...matchingResult } : registro
            }
            return registro
          })
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold">Formulario para Staff</h2>
